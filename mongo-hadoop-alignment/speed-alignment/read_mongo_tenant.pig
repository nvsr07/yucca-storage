...
socialPhoenixSchemaName, dataSolrCollectionName, measuresSolrCollectionName, mediaSolrCollectionName, socialSolrCollectionName' , 'id')
...
socialPhoenixSchemaName:chararray, dataSolrCollectionName:chararray, measuresSolrCollectionName:chararray, mediaSolrCollectionName:chararray, 
socialSolrCollectionName:chararray);
