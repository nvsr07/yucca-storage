...
dbTenant.getCollection(nomeColl).remove({idDataset:env.DATASET,datasetVersion:{$lte:env.VERSION},origin:env.ORIGIN},{writeConcern:{w: 'majority',j:true}});
print('DB_'+myTenant+'.getCollection("'+nomeColl+'").remove({idDataset:'+env.DATASET+',datasetVersion:{$lte:'+env.VERSION+'},origin:"'+env.ORIGIN+'"});');
