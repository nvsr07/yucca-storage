...
from yuccausage.mongodb import (get_support_db, setup_connection,
                                _clear_mongodb_configuration, get_statistics_collection,
                                get_data_collections)
from yuccausage.utils import first_month_day, thirtydays_ago, begin_of_day, isodate, sevendays_ago
...
class TestCollectionLookupUtilities(object):
    ...
    def test_connected_collection(self):
        ...
        assert col.full_name == 'yuccausage_TESTS_DB_STATS.test_statistics', col.full_name
    ...
    def test_tenant_collections(self):
        ...
        assert measures_col.full_name == 'yuccausage_TESTS_DB_smartlab.measures'
        assert data_col.full_name == 'yuccausage_TESTS_DB_smartlab.data'
        assert social_col.full_name == 'yuccausage_TESTS_DB_smartlab.social'
        assert media_col.full_name == 'yuccausage_TESTS_DB_smartlab.media'
        assert binary_col.full_name == 'yuccausage_TESTS_DB_smartlab.binary'
...
class TestDateTimeUtils(object):
    ...
    def test_sevendays_ago(self):
        assert sevendays_ago(datetime(2001, 1, 8, 11, 32, 52)) == datetime(2001, 1, 1)
