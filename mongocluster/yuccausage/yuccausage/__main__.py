...
from .utils import first_month_day, begin_of_day, isodate, thirtydays_ago, sevendays_ago
...
def main():
    parser = argparse.ArgumentParser(
        description='Gathers cross tenant usage statistics from the YUCCA platform.'
    )
